...
<html>
	...
	<body bgcolor="#D9DFAA">
		...
		<s:form action="addXs" method="post"	enctype="multipart/form-data" validate="true">
			<table border="0" cellspacing="0" cellpadding="1">
				<tr>
					<td>
						<s:textfield name="xs.xh" key="xh" value=""></s:textfield>
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<s:textfield name="xs.zyId" label="专业id" value=""></s:textfield>
				</tr>
				<tr>
				<!-- 调用JS写的时间控件，非常方便时间的选择，而且输入框设为只读，防止输入错误的格式 -->
					<s:textfield name="xs.cssj" label="出生时间" ></s:textfield>
				</tr>
				<!-- <tr>
					<td>
